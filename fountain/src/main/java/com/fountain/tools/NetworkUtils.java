 ...
 * Creation Time : 2017/12/21<br/>
 * Description : Network工具类<br/>
 */
public class NetworkUtils {
    private volatile static NetworkUtils mInstance;
    public static final int NETWORK_NO = -1;        // 无网络
    ...
    public static final int NETWORK_UNKNOWN = 5;    // 未知的网络
    /******************************************************************/
